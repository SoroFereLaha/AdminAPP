...
<body class="antialiased">
    ...
    <div class=" bg-gray-250 justify-between" height="" id="scroll">
        ...
        <h2 class="p-20 text-4xl font-bold">Un mot de bienvenu du directeur</h2>
...
<div class="mx-auto text-center md:max-w-xl lg:max-w-3xl pt-10">
    <h3
        class="mb-6 text-3xl font-bold text-neutral-800 ">
        Temoignage
    </h3>
    <p class="mb-6 pb-2 md:mb-12 md:pb-0">
        Quelques temoignages de nos anciens eleves maintenant diplomé
    </p>
</div>

<!-- Container for the Testimonials -->
<div class="grid gap-6 text-center md:grid-cols-3 lg:gap-12 pb-10">
    <!-- First Testimonial -->
...
<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-3">
        <div>
            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Compagnie</h2>
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">AdminAPP™</a>. All Rights Reserved.
        </span>
