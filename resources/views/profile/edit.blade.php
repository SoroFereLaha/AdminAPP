                ...
                <div class="max-w-xl">
                    ...
                    <form action="{{ route('profile.upload.photo') }}" method="POST" enctype="multipart/form-data" class="block">
                        ...
                        <div class="flex justify-start">
                            <button type="submit" class="bg-blue-800 hover:bg-blue-700 text-white text-xs  font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Voir photo de profil</button>
                            <button id="changePhotoButton" class="ml-4 bg-gray-800 hover:bg-gray-600 text-white text-xs font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Modifier photo de profil</button>
                        </div>
                    </form>
                </div>
            </div>
