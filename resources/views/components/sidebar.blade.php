<div class="h-full px-3 py-10 pb-4 overflow-y-auto bg-white dark:bg-[#424549]" x-data="{dropDownOpen:false}">
    <ul class="space-y-2 font-medium">
        ...
        <li>
            ...
            <ul id="dropdown-example" class=" py-2 space-y-2" :class="{'hidden':!dropDownOpen,'block':dropDownOpen}">
                ...
                <li>
                    <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Professeur</a>
                </li>
                <li>
