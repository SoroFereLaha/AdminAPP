<x-app-layout>
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-[#424549]">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Abonnement</span>
            ...
            <li>
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Lorem</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
