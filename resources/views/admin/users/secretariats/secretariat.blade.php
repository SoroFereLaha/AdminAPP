            ...
            <div class="big-container flex flex-col   w-4/5 ">
                ...
                <div class="flex items-center my-10">
                    <a href="{{ route('admin.users.secretariats.inscriptions') }}">
                        <div class="container  shadow-lg  ring ring-blue-400  ring-offset-4 rounded-lg  bg-blue-100 w-80 h-60 mx-10">
                            ...
                            <div class="w-80 h-3/5 flex items-center justify-center">
                    ...
                    <a href="{{ route('admin.users.secretariats.inscriptions') }}">
                        <div class="container shadow-lg  ring ring-blue-400  ring-offset-4 rounded-lg  bg-indigo-100 w-80 h-60 mx-5">
                            <div class="haut my-5 flex mx-10 pt-7 ">
                                ...
                                <span class="font-black  flex ">
                                    ...
                                    <span class="text-2xl my-1 mx-2">Les absences</span>
                                </span>
                    ...
                    <a href="{{ route('admin.users.secretariats.inscriptions') }}">
                        <div class="container shadow-lg  ring ring-blue-400  ring-offset-4 rounded-lg  bg-violet-100 w-80 h-60 mx-5">
                            <div class="haut my-5 flex mx-10 pt-7 ">
                                ...
                                <span class="font-black flex ">
                                    ...
                                    <span class="text-2xl my-1 mx-2">Les payements</span>
                                </span>
